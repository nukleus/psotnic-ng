...
int firedns_getip4(const char *name);
int firedns_getip4list(const char *name);
int firedns_getip6(const char *name);
int firedns_getip6list(const char *name);
int firedns_gettxt(const char *name);
int firedns_gettxtlist(const char *name);
int firedns_getmx(const char *name);
...
int firedns_getcname(const char *name);
...
struct in_addr *firedns_aton4_r(const char *ipstring);
...
struct in_addr *firedns_resolveip4(const char *name);
struct firedns_ip4list *firedns_resolveip4list(const char *name);
struct in6_addr *firedns_resolveip6(const char *name);
struct firedns_ip6list *firedns_resolveip6list(const char *name);
char *firedns_resolvetxt(const char *name);
struct firedns_txtlist *firedns_resolvetxtlist(const char *name);
char *firedns_resolvemx(const char *name);
...
struct in_addr *firedns_resolveip4_r(const char *name);
struct firedns_ip4list *firedns_resolveip4list_r(const char *name);
struct in6_addr *firedns_resolveip6_r(const char *name);
